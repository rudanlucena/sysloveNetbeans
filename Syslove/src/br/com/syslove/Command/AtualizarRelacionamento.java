 ...
 * @author alexalins
 */
public class AtualizarRelacionamento implements Command {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        try {
            ...
            gr.atualizaRelacionamento(usuario1, usuario2, tipo);
        } catch (PersistenciaException | SQLException ex) {
            Logger.getLogger(AtualizarRelacionamento.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
